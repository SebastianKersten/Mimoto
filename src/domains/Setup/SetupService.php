...
class SetupService
{
    ...
    private function getTableStructure($sTableName)
    {
        ...
        switch($sTableName)
        {
            ...
            case CoreConfig::MIMOTO_API: $sTableStructure = '[{"Field":"mimoto_id","Type":"int(10) unsigned","Null":"NO","Key":"PRI","Default":null,"Extra":"auto_increment"},{"Field":"mimoto_created","Type":"datetime","Null":"YES","Key":"","Default":null,"Extra":""},{"Field":"mimoto_modified","Type":"datetime","Null":"YES","Key":"","Default":null,"Extra":"on update CURRENT_TIMESTAMP"},{"Field":"name","Type":"varchar(255)","Null":"YES","Key":"","Default":null,"Extra":""},{"Field":"isEnabled","Type":"enum(\'0\',\'1\')","Null":"YES","Key":"","Default":null,"Extra":""},{"Field":"outputRawResponse","Type":"enum(\'0\',\'1\')","Null":"YES","Key":"","Default":null,"Extra":""}]'; break;
...
//            case CoreConfig::MIMOTO_FORM_FIELD_OPTION_MAP: $sTableStructure = '[{"Field":"mimoto_id","Type":"int(10) unsigned","Null":"NO","Key":"PRI","Default":null,"Extra":"auto_increment"},{"Field":"mimoto_created","Type":"datetime","Null":"YES","Key":"","Default":null,"Extra":""},{"Field":"mimoto_modified","Type":"datetime","Null":"YES","Key":"","Default":null,"Extra":"on update CURRENT_TIMESTAMP"},{"Field":"targetKey","Type":"varchar(255)","Null":"YES","Key":"","Default":null,"Extra":""},{"Field":"originKey","Type":"varchar(255)","Null":"YES","Key":"","Default":null,"Extra":""}]'; break;
            ...
            case CoreConfig::MIMOTO_USER: $sTableStructure = '[{"Field":"mimoto_id","Type":"int(10) unsigned","Null":"NO","Key":"PRI","Default":null,"Extra":"auto_increment"},{"Field":"mimoto_extensionid","Type":"int(10) unsigned","Null":"YES","Key":"","Default":null,"Extra":""},{"Field":"mimoto_created","Type":"datetime","Null":"YES","Key":"","Default":null,"Extra":""},{"Field":"mimoto_modified","Type":"datetime","Null":"YES","Key":"","Default":null,"Extra":"on update CURRENT_TIMESTAMP"},{"Field":"firstName","Type":"varchar(255)","Null":"YES","Key":"","Default":null,"Extra":""},{"Field":"lastName","Type":"varchar(255)","Null":"YES","Key":"","Default":null,"Extra":""},{"Field":"email","Type":"varchar(255)","Null":"YES","Key":"","Default":null,"Extra":""},{"Field":"password","Type":"varchar(255)","Null":"YES","Key":"","Default":null,"Extra":""}]'; break;
