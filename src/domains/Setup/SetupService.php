...
class SetupService
{
    ...
    private function getTableStructure($sTableName)
    {
        ...
        switch($sTableName)
        {
            ...
            case CoreConfig::MIMOTO_DATASET: $sTableStructure = '[{"Field":"mimoto_id","Type":"int(10) unsigned","Null":"NO","Key":"PRI","Default":null,"Extra":"auto_increment"},{"Field":"mimoto_created","Type":"datetime","Null":"YES","Key":"","Default":null,"Extra":""},{"Field":"mimoto_modified","Type":"datetime","Null":"YES","Key":"","Default":null,"Extra":"on update CURRENT_TIMESTAMP"},{"Field":"name","Type":"varchar(255)","Null":"YES","Key":"","Default":null,"Extra":""}]'; break;
