...
class FormService
{
    ...
    public function getCoreFormByEntityTypeId($sEntitytypeId)
    {
        switch($sEntitytypeId)
        {
            ...
            case CoreConfig::MIMOTO_FORM_INPUT_ENTITY: return CoreConfig::COREFORM_INPUT_ENTITY; break;
            ...
            case CoreConfig::MIMOTO_FORM_INPUT_PASSWORD: return CoreConfig::MIMOTO_FORM_INPUT_PASSWORD; break;
