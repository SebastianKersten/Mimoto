...
class UserRolesController
{
    ...
    public function userRoleView(Application $app, $nItemId)
    {
        ...
        $page->setVar('pageTitle', array(
                ...
                (object) array(
                    "label" => '<span data-mimoto-value="'.CoreConfig::MIMOTO_FORMATTINGOPTION.'.'.$eUserRole->getId().'.name">'.$eUserRole->getValue('name').'</span>',
    ...
    {
        // 1. load
        $eSelection = Mimoto::service('data')->get(CoreConfig::MIMOTO_USER_ROLE, $nItemId);
