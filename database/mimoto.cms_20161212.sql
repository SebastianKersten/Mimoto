...
-- ----------------------------
BEGIN;
INSERT INTO `_MimotoAimless__connections__project` VALUES ('1', '1000', '1006', '3', '1100', '1', '0'), ('2', '1000', '1006', '3', '1100', '2', '1'), ('3', '1000', '1006', '3', '1100', '3', '2'), ('4', '1000', '1006', '2', '1100', '4', '0'), ('100', '1100', '1102', '1', '1600', '2', '0');
COMMIT;
...
-- ----------------------------
--  Table structure for `w88`
-- ----------------------------
DROP TABLE IF EXISTS `w88`;
CREATE TABLE `w88` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `created` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
