...
CREATE TABLE `_Mimoto_dataset` (
  ...
  `isHiddenFromMenu` enum('0','1') CHARACTER SET latin1 DEFAULT NULL,
  `created` datetime DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
-- Table structure for _Mimoto_form_field
-- ----------------------------
DROP TABLE IF EXISTS `_Mimoto_form_field`;
CREATE TABLE `_Mimoto_form_field` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `_Mimoto_form_inputoption_map` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `targetKey` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `_Mimoto_selectionrule` (
  ...
  `typeVarName` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  `idAsVar` int(1) DEFAULT NULL,
  `idVarName` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  `propertyAsVar` int(1) DEFAULT NULL,
  `propertyVarName` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  `created` datetime DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
