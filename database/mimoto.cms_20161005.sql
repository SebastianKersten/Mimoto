...
-- ----------------------------
BEGIN;
INSERT INTO `_MimotoAimless__interaction__form` VALUES ('2', 'form_person', 'Test', '2016-08-10 14:29:42', null), ('3', 'client', 'A simple form to add and edit clients', '2016-06-27 14:06:17', null), ('100', 'form_entity_create', 'Core form for creating entities', '2016-08-17 12:21:21', null), ('200', 'form_entity_edit', 'Core form for changing existing entities', '2016-08-17 12:26:10', null);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `_MimotoAimless__interaction__form_input_checkbox` VALUES ('1', 'State', 'Person is currently active on the project', '2016-08-15 13:47:47', 'state');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `_MimotoAimless__interaction__form_input_dropdown` VALUES ('1', 'Number of hours', '[\"0-2\", \"0 - 2 hours per day\", \"2-4\", \"2 - 4 hours a day\", \"4-8\", \"4-8 hours a day\"]', '2016-08-15 13:49:42', 'numberofhours');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `_MimotoAimless__interaction__form_input_image` VALUES ('1', 'Image', 'This is an image', '2016-08-15 13:47:47', null);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `_MimotoAimless__interaction__form_input_list` VALUES ('1', 'List', 'Tis is a list', '2016-08-15 13:47:47', null);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `_MimotoAimless__interaction__form_input_radiobutton` VALUES ('1', 'Number of hours', '[\"0-2\", \"0 - 2 hours per day\", \"2-4\", \"2 - 4 hours a day\", \"4-8\", \"4-8 hours a day\"]', '2016-08-15 13:49:42', 'numberofhours');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `_MimotoAimless__interaction__form_input_textline` VALUES ('1', 'Name', null, null, 'false', '/[a-zA-Z09-]/', '10', '2016-08-10 16:13:50', 'name'), ('2', 'Role', null, null, 'false', null, null, '2016-08-12 10:24:05', 'role'), ('3', 'Name', 'This name will be used around the whole application', 'Enter the client\'s name', 'true', '/[a-zA-Z09-]/', '10', '2016-10-02 13:08:25', 'name'), ('100', 'Name', null, null, 'false', '/[a-zA-Z09-]/', '20', '2016-08-17 13:18:21', 'name'), ('200', 'Name', null, null, 'false', '/[a-zA-Z09-]/', '20', '2016-08-17 13:18:36', 'name');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `_MimotoAimless__interaction__form_input_video` VALUES ('1', 'Video', 'This is a video', '2016-08-15 13:47:47', null);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `_MimotoAimless__interaction__form_layout_groupend` VALUES ('1', '2016-08-04 08:38:28'), ('3', '2016-10-02 13:07:53'), ('100', '2016-08-17 13:58:02'), ('200', '2016-08-17 13:58:07');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `_MimotoAimless__interaction__form_layout_groupstart` VALUES ('1', 'First group', '2016-08-04 08:38:28'), ('3', 'Client group', '2016-10-02 13:07:26'), ('100', null, '2016-08-17 13:57:43'), ('200', null, '2016-08-17 13:57:53');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `client` VALUES ('1', 'VanMoof', '2016-02-17 09:57:06'), ('2', 'Bugaboo', '2016-02-22 17:54:20'), ('3', 'KNVB', '2016-02-22 17:54:29'), ('4', 'De Correspondent', '2016-03-04 22:41:00'), ('5', 'Respondens', '2016-03-04 22:41:11'), ('6', 'IDFA - Modified = 2016:08:31 12.07.38', '2016-08-25 16:01:53');
COMMIT;
