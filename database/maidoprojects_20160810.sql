...
-- ----------------------------
BEGIN;
INSERT INTO `_mimoto_entity` VALUES ('1', 'person', '', '2016-07-29 14:13:46');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `_mimoto_entity_connections` VALUES ('1', '1', 'epid2', 'eid2', '1', '0'), ('3', '1', 'epid2', 'eid2', '2', '1');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `_mimoto_entityproperty` VALUES ('1', 'name', 'value', '2016-07-27 12:24:53'), ('2', 'role', 'value', '2016-07-27 16:45:01');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `_mimoto_entityproperty_connections` VALUES ('1', '1', 'epid2', 'eid2', '1', '0'), ('2', '2', 'epid2', 'eid2', '2', '1');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `_mimoto_entitypropertysetting` VALUES ('1', 'type', 'value', 'textline', '2016-08-10 13:54:51'), ('2', 'type', 'value', 'textline', '2016-08-10 13:55:02');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `_mimoto_form_connections` VALUES ('1', '2', 'epid_fields', 'eid100', '1', '0'), ('2', '2', 'epid_fields', 'eid101', '1', '1'), ('3', '2', 'epid_fields', 'eid100', '2', '2'), ('4', '2', 'epid_fields', 'eid102', '1', '3');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `_mimoto_form_input_textline` VALUES ('1', 'name', 'blabla', '2016-08-10 16:13:50');
COMMIT;

-- ----------------------------
--  Table structure for `_mimoto_form_output_group_end`
-- ----------------------------
DROP TABLE IF EXISTS `_mimoto_form_output_group_end`;
CREATE TABLE `_mimoto_form_output_group_end` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `created` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
-- ----------------------------
--  Records of `_mimoto_form_output_group_end`
-- ----------------------------
BEGIN;
INSERT INTO `_mimoto_form_output_group_end` VALUES ('1', '2016-08-04 08:38:28');
COMMIT;

-- ----------------------------
--  Table structure for `_mimoto_form_output_group_start`
-- ----------------------------
DROP TABLE IF EXISTS `_mimoto_form_output_group_start`;
CREATE TABLE `_mimoto_form_output_group_start` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
--  Records of `_mimoto_form_output_group_start`
-- ----------------------------
BEGIN;
INSERT INTO `_mimoto_form_output_group_start` VALUES ('1', 'First group', '2016-08-04 08:38:28');
COMMIT;
