...
CREATE TABLE `_MimotoAimless__core__entityproperty` (
  ...
  `created` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10032 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
-- ----------------------------
BEGIN;
INSERT INTO `_MimotoAimless__interaction__form_input_textline` VALUES ('1', 'Name', null, null, null, '2016-08-10 16:13:50'), ('2', 'Role', null, null, null, '2016-08-12 10:24:05'), ('3', 'Name', 'This field is connected to an entity\'s property', 'Enter the client\'s name', null, '2016-10-02 13:08:25'), ('4', 'Custom var', 'Dit is een custom var', 'Enter the value of this custom var', null, '2016-10-09 15:25:54'), ('50', 'Name', 'The project\'s name', 'Enter a name', null, '2016-10-09 16:56:43'), ('51', 'Description', 'The project\'s description', 'Enter a description', null, '2016-10-09 16:57:38');
COMMIT;
